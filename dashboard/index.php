<?php
    ...
    $rules = mysqli_query($db,"SELECT * FROM rules");
    $data = mysqli_num_rows($rules);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        <div class="card mb-4 bg-gradient-info text-white">
                            <div class="card-body ">
                                    <h2>
                                        <center>
                                            Selamat Datang
                                    ...
                                    <center>
                                        Sistem Pendukung Keputusan Untuk Menentukan Kenaikan Kelas Siswa Menggunakan Metode Tsukamoto
                                    </center>
                            </div>
                        </div>
